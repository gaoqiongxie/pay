 ...
 */
@Component
public class ALiPayWapStrategy extends AliPay implements PayStrategy{

	@Override
	public Charge payExcute(PayReq req) {
		Charge charge = new Charge();
		charge.setPrePayInfo(unifiedOrder(req, WAP_TYPE).replace("<script>document.forms[0].submit();</script>", "").
